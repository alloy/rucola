...
module Rucola
  class FSEvents
    ...
    #   will cause every fsevent since the "beginning of time" to be reported. Use KFSEventStreamEventIdSinceNow
    #   if you want to receive events that have happened after this call. (Default: KFSEventStreamEventIdSinceNow).
